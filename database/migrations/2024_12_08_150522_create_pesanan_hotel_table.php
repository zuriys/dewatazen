...
return new class extends Migration
{
    ...
    {
        Schema::create('pesanan_hotel', function (Blueprint $table) {
            ...
            $table->unsignedBigInteger('id_penginapan')->nullable(); // kolom id_penginapan, tanpa auto increment
    ...
    {
        Schema::dropIfExists('pesanan_hotel');
    }
};
